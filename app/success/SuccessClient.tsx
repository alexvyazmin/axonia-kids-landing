    ...
    <main className="min-h-screen bg-milky">
      <div className="max-w-prose mx-auto px-4 py-12 md:py-16">
        <article className="text-lg leading-relaxed space-y-6 text-slate-dark">
          ...
          <p>
            Если оплата прошла успешно, ссылка на скачивание Нейробука уже
            отправляется на email, который вы указали при покупке. Проверьте
            почту (и папку «Спам»).
          </p>
          <p className="text-base opacity-80">
            Письмо не пришло? Ниже можно получить ссылку вручную — укажите{" "}
            <strong>ID платежа</strong> из чека ЮKassa или ваш{" "}
            <strong>email</strong>.
          </p>
